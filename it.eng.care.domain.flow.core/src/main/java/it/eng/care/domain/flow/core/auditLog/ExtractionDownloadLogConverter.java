...
public class ExtractionDownloadLogConverter implements PrivacyManagerLogConverter<byte[]>{
	...
	public List<EventResponseAM> convertResponse(byte[] output, Object[] input) {
		...
		attac.setName("Log estrazione " + estrazione);
	...
	public EventResourceAM convertRequest(Object[] args) {
		...
		request.setRequest("Download log estrazione");
