...
public class TabgenFieldDOToDTOWithTableConverter implements Converter<TabgenFieldDO, TabgenField> {
	...
	public void post() {
		...
		mapper.register(new BeanMappingBuilder() {
		    ...
		    protected void configure() {
				...
				.fields("tabgen", "tabgen", FieldsMappingOptions.useMapId(TabgenDOToDTOBareConverter.getMapId()))
				.exclude("tabgenField")
		        .exclude("tabgenFields");
		    }
		});
	...
	public static String getMapId() {
		return "TABGEN_DO_to_DTO_WITH_TABLE";
	}
