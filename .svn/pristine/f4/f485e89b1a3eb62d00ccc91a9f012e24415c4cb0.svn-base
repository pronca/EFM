...
//	    property = "id"
//	)
public class TabgenValue implements Serializable {
    private static final long serialVersionUID = 1L;

    private String id;

    private Integer alwaysEnabled;
...
//    @JsonBackReference
    ...
    private Map<String, String> freeFieldsMap;
    ...
    public Integer getAlwaysEnabled() {
        return this.alwaysEnabled;
    }

    public void setAlwaysEnabled(Integer alwaysEnabled) {
    ...
    public Map<String, String> getFreeFieldsMap() {
        return freeFieldsMap;
    }

    public void setFreeFieldsMap(Map<String, String> freeFieldsMap) {
        this.freeFieldsMap = freeFieldsMap;
    }
